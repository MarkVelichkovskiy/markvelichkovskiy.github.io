...
export class App {
    ...
    render() {
        ...
        this.logoText.className = "header-logo-text";
        this.logoTextGreen.className = "header-logo-text green"
        this.headerButtons.className = 'header-buttons';
        this.loginButton.className = "header-login-button";
        this.createButton.className = "header-create-button";
